...
export const useManageLiveMatch = () => {
   ...
   * gesture: which racks move is libs/algorithms/night.ts's decision, and it is checkable
  ...
  return {
     ...
     * fixtures are (libs/algorithms/bracket/): the optimistic row and the row that comes

...
import { HiPlus, HiPencil, HiTrash, HiHome } from "react-icons/hi";
                                        ...
                                        {(players || []).map((player) => (
                                            ...
                                            >
                                                ...
                                                <td className="py-3 px-3">
                                                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${player.category === 1 ? 'bg-yellow-100 text-yellow-800' :
                                                        player.category === 2 ? 'bg-gray-100 text-gray-800' :
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        <div className="fixed inset-0 transition-opacity z-0" aria-hidden="true" onClick={closeModal}>
                        ...
                        <div className="inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle z-1 relative">
                            <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <PlayerForm
                                    initialValues={editingPlayer ? { name: editingPlayer.name, category: editingPlayer.category } : undefined}

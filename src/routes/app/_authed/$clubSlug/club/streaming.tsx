 ...
 *  table's YouTube stream key together (ClubStreamingCard), then the OBS
 *  scene collection built from those camera URLs (ClubObsCard). Its own
 *  tab, split out of Tables: this is a one-time setup task for the

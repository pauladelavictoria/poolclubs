...
CREATE TABLE IF NOT EXISTS "public"."club_streams" (
    "id" integer NOT NULL,
    "club_id" integer NOT NULL,
    "table_id" integer NOT NULL,
...
ALTER TABLE "public"."club_streams" OWNER TO "postgres";


ALTER TABLE "public"."club_streams" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."club_streams_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."club_table_cameras" (
    "table_id" integer NOT NULL,
    "club_id" integer NOT NULL,
    "camera_url" "text" NOT NULL,
    CONSTRAINT "club_table_cameras_camera_url_check" CHECK ((("char_length"("btrim"("camera_url")) >= 1) AND ("char_length"("btrim"("camera_url")) <= 500)))
);


ALTER TABLE "public"."club_table_cameras" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."club_youtube" (
    "club_id" integer NOT NULL,
...
ALTER TABLE "public"."club_youtube" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."live_matches" (
    ...
    CONSTRAINT "live_matches_record_privacy_check" CHECK (("record_privacy" = ANY (ARRAY['public'::"text", 'unlisted'::"text"]))),
...
ALTER TABLE "public"."stream_sessions" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."stream_sessions_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE TABLE IF NOT EXISTS "public"."table_encoders" (
    "table_id" integer NOT NULL,
    "club_id" integer NOT NULL,
...
ALTER TABLE "public"."table_encoders" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."club_streams"
    ADD CONSTRAINT "club_streams_pkey" PRIMARY KEY ("id");



ALTER TABLE ONLY "public"."club_streams"
    ADD CONSTRAINT "club_streams_table_id_key" UNIQUE ("table_id");



ALTER TABLE ONLY "public"."club_table_cameras"
    ADD CONSTRAINT "club_table_cameras_pkey" PRIMARY KEY ("table_id");
...
ALTER TABLE ONLY "public"."club_youtube"
    ADD CONSTRAINT "club_youtube_pkey" PRIMARY KEY ("club_id");
...
ALTER TABLE ONLY "public"."stream_sessions"
    ADD CONSTRAINT "stream_sessions_live_match_id_key" UNIQUE ("live_match_id");
...
ALTER TABLE ONLY "public"."table_encoders"
    ADD CONSTRAINT "table_encoders_pkey" PRIMARY KEY ("table_id");
...
ALTER TABLE ONLY "public"."club_streams"
    ADD CONSTRAINT "club_streams_club_id_fkey" FOREIGN KEY ("club_id") REFERENCES "public"."clubs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."club_streams"
    ADD CONSTRAINT "club_streams_table_id_fkey" FOREIGN KEY ("table_id") REFERENCES "public"."club_tables"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."club_table_cameras"
    ADD CONSTRAINT "club_table_cameras_club_id_fkey" FOREIGN KEY ("club_id") REFERENCES "public"."clubs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."club_table_cameras"
    ADD CONSTRAINT "club_table_cameras_table_id_fkey" FOREIGN KEY ("table_id") REFERENCES "public"."club_tables"("id") ON DELETE CASCADE;
...
ALTER TABLE ONLY "public"."club_youtube"
    ADD CONSTRAINT "club_youtube_club_id_fkey" FOREIGN KEY ("club_id") REFERENCES "public"."clubs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."club_youtube"
    ADD CONSTRAINT "club_youtube_connected_by_fkey" FOREIGN KEY ("connected_by") REFERENCES "auth"."users"("id");
...
ALTER TABLE ONLY "public"."table_encoders"
    ADD CONSTRAINT "table_encoders_club_id_fkey" FOREIGN KEY ("club_id") REFERENCES "public"."clubs"("id") ON DELETE CASCADE;



ALTER TABLE ONLY "public"."table_encoders"
    ADD CONSTRAINT "table_encoders_table_id_fkey" FOREIGN KEY ("table_id") REFERENCES "public"."club_streams"("table_id") ON DELETE CASCADE;
...
CREATE POLICY "Admin can manage table cameras" ON "public"."club_table_cameras" TO "authenticated" USING ("public"."is_club_admin"("club_id")) WITH CHECK ("public"."is_club_admin"("club_id"));
...
CREATE POLICY "Members can see their club's encoders" ON "public"."table_encoders" FOR SELECT TO "authenticated" USING ("public"."is_club_member"("club_id"));
...
ALTER TABLE "public"."club_streams" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."club_table_cameras" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."club_tables" ENABLE ROW LEVEL SECURITY;


ALTER TABLE "public"."club_youtube" ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE "public"."table_encoders" ENABLE ROW LEVEL SECURITY;
...
GRANT ALL ON TABLE "public"."club_streams" TO "service_role";



GRANT ALL ON SEQUENCE "public"."club_streams_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."club_streams_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."club_streams_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."club_table_cameras" TO "anon";
GRANT ALL ON TABLE "public"."club_table_cameras" TO "authenticated";
GRANT ALL ON TABLE "public"."club_table_cameras" TO "service_role";
...
GRANT ALL ON TABLE "public"."club_youtube" TO "service_role";
...
GRANT ALL ON SEQUENCE "public"."stream_sessions_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."stream_sessions_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."stream_sessions_id_seq" TO "service_role";



GRANT ALL ON TABLE "public"."table_encoders" TO "anon";
GRANT ALL ON TABLE "public"."table_encoders" TO "authenticated";
GRANT ALL ON TABLE "public"."table_encoders" TO "service_role";
